...
use base 'Exporter';
our @EXPORT = qw(prettify_message BOLD RESET GREEN RED YELLOW GREEN_BACKGROUND RED_B);
...
use constant GREEN_BACKGROUND => (!defined($ENV{'WG_NO_COLOR'})) ? "\e[42m" : "";
use constant RED_B => (!defined($ENV{'WG_NO_COLOR'})) ? "\e[41m" : "";
